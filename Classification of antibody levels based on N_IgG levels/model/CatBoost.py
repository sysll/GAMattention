...
# 创建CatBoost分类器
clf = CatBoostClassifier(learning_rate=0.1, depth=7, iterations=2000, l2_leaf_reg=3,
                           subsample=0.8, colsample_bylevel=0.8, border_count=254)
...
print("准确率:", accuracy)
np.save('D:\\Users\\ASUS\\Desktop\\论文\\基于S1_lgG的阴阳分类\\结果\\CatBoost_predict.npy', y_pred_prob)
np.save('D:\\Users\\ASUS\\Desktop\\论文\\基于S1_lgG的阴阳分类\\结果\\CatBoost_test.npy', y_test)
