...
#在这丢掉病人的ID是为了初始化
train_drop = train.drop(['S1_IgG', '病人ID', '性别', '高血压(0=无，1=有)', '糖尿病(0=无，1=有)'], axis=1)
...
data_transform.insert(0, 'S1_IgG', train['S1_IgG'].tolist())
data_transform.insert(0, '病人ID', train['病人ID'].tolist())
#把小于602的数据删掉
data_transform = data_transform[data_transform['S1_IgG'] >= 602]
# #把大于10000的用1，小于的用10000代替
data_transform['S1_IgG'] = data_transform['S1_IgG'].apply(lambda x: 0 if x <= 10000 else 1)
print(data_transform.shape)
# data_transform.to_excel(
#     "D:\\Users\\ASUS\\Desktop\\论文\\基于S1_lgG的阴阳分类\\数据处理\\processed train_data without division.xlsx",
#     engine="openpyxl")
...
test_data = test.drop(['S1_IgG', '病人ID', '性别', '高血压(0=无，1=有)', '糖尿病(0=无，1=有)'], axis=1)
...
data_transform.insert(0, 'S1_IgG', test['S1_IgG'].tolist())
...
# data_transform.to_excel(
#     "D:\\Users\\ASUS\\Desktop\\论文\\基于S1_lgG的阴阳分类\\数据处理\\processed test_data without division.xlsx",
#     engine="openpyxl")
