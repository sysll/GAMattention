...
import random
# 读取原始Excel文件
input_file = 'D:\\Users\\ASUS\\Desktop\\论文\\基于N_lgG的阴阳分类\\数据处理\\processed train_data without division.xlsx'
...
# 获取满足条件的索引
condition_indices = df[df['N_IgG'] == 1].index
...
condition_indices = df[df['N_IgG'] == 0].index
...
# 将随机样本保存到另一个Excel文件
output_file = 'D:\\Users\\ASUS\\Desktop\\论文\\基于N_lgG的阴阳分类\\用于调参的模型\\N_used for train.xlsx'
shuffled_df.to_excel(output_file, index=False)



# 读取原始Excel文件
input_file = 'D:\\Users\\ASUS\\Desktop\\论文\\基于N_lgG的阴阳分类\\数据处理\\processed test_data without division.xlsx'
df = pd.read_excel(input_file)
...
# 将随机样本保存到另一个Excel文件
output_file = 'D:\\Users\\ASUS\\Desktop\\论文\\基于N_lgG的阴阳分类\\用于调参的模型\\N_used for test.xlsx'
