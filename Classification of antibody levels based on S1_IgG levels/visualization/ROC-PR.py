...
model1 = np.load('D:\\Users\\ASUS\Desktop\\论文\\基于N_lgG的阴阳分类\\结果\\AdaBoost_predict.npy')
model2 = np.load('D:\\Users\\ASUS\Desktop\\论文\\基于N_lgG的阴阳分类\\结果\\CatBoost_predict.npy')
model3 = np.load('D:\\Users\\ASUS\Desktop\\论文\\基于N_lgG的阴阳分类\\结果\\Light_GBM_predict.npy')
model4 = np.load('D:\\Users\\ASUS\Desktop\\论文\\基于N_lgG的阴阳分类\\结果\\Seq2seq+attention_predict.npy')
model5 = np.load('D:\\Users\\ASUS\Desktop\\论文\\基于N_lgG的阴阳分类\\结果\\Seq2seq_SA_predict.npy')
model6 = np.load("D:\\Users\\ASUS\\Desktop\\论文\\基于N_lgG的阴阳分类\\结果\\Seq2seq_NA.npy")
model7 = np.load("D:\\Users\\ASUS\\Desktop\\论文\\基于N_lgG的阴阳分类\\结果\\LSTM_predict.npy")
model8 = np.load("D:\\Users\\ASUS\\Desktop\\论文\\基于N_lgG的阴阳分类\\结果\\GAN_predict.npy")

y_true = np.load('D:\\Users\\ASUS\\Desktop\\论文\\基于N_lgG的阴阳分类\\结果\\CatBoost_test.npy')
